class StudentsController < ApplicationController
  ...
  def edit
    ...
    Stripe.api_key = ENV['Javier_user_Secret_Key'] #replace with @user.access_code
    @publishable_key = ENV['Javier_user_Publishable_key'] #replace with @user.publishable_key
 end
  # POST /students
  # POST /students.json
  def create
